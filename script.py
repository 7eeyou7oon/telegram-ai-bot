...
knowledge_base = {
    ...
    "Чистка ПК": {
        ...
        "aliases": ["почистить компьютер", "пк грязный", "чистка пк", "чистка ноута", "чистка ноутбука", "чистка"]
    },
    ...
    "TRADE-IN ноутбуков": {
        "text": "TRADE-INN — Индивидуальная оценка.",
...
async def export(message: types.Message):
    ...
    telegram_data = list(get_requests(1000))

    site_data = list(get_site_orders())
